...
The following figures provide a visual entry point into Mission Framework. They are explanatory views derived from the canonical concepts in the repository. Where a figure and a normative definition differ, the normative Markdown definition takes precedence.

## Mission Framework overview

![Mission Framework overview](mission-framework-overview.svg)
...
![Governed Publication Pipeline](publication-pipeline.svg)
